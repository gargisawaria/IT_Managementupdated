    ...
    public class ManageDevicesController : Controller
    {
        ...
        public IActionResult History(Devices updatedDevice)
        {
            var deviceHistory = new DeviceHistory
            {
                ...
                UserId = updatedDevice.Status ? updatedDevice.UserId : null, // Set to null if Status is null
                UpdatedBy = "Admin",
                ...
                CategoryName = updatedDevice.CategoryId != null
                    ? _context.Categories
                        ...
                        .FirstOrDefault()
                    : null
                // Add other relevant fields from Devices, Users, and Categories models
            };
        ...
        public IActionResult Edit(Devices updatedDevice)
        {
            ...
            {
                // Log the exception details or output it to the console for debugging
